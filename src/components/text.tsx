import { InputContainer, ErrorText, TextInput, Text } from './styles';
...
export const TextS: FC<InTextProps> = React.memo((props) => {
    ...
    return (
        <InText {...props} fontSize={11} color={getColor(type, theme)}/>
    );
});
...
export const TextL: FC<InTextProps> = React.memo((props) => {
    ...
    const theme = useTheme();
    return (
        <InText {...props} fontSize={14} color={getColor(type, theme)}/>
    );
});
...
export const TextXL: FC<InTextProps> = React.memo((props) => {
    ...
    const theme = useTheme();
    return (
        <InText {...props} fontSize={15} color={getColor(type, theme)}/>
    );
});
...
export const TextXXXL: FC<InTextProps> = React.memo((props) => {
    ...
    const theme = useTheme();
    return (
        <InText {...props} fontSize={20} color={getColor(type, theme)}/>
    );
});
...
export const TextLX: FC<InTextProps> = React.memo((props) => {
    ...
    const theme = useTheme();
    return (
        <InText {...props} fontSize={48} color={getColor(type, theme)}/>
    );
});
